...
public class problema4 {
	public static void main(String[] args) {
        ...
        ((Student) student).addCourseGrade("Matematica", 9);
        ((Teacher) teacher).addCourse("Programare");
        ((Teacher) teacher).addCourse("Algoritmica");
        ((Teacher) teacher).addCourse("Matematica");
        ((Teacher) teacher).addCourse("Programare");
        ((Teacher) teacher).removeCourse("Algoritmica");
        assert (Math.abs(((Student) student).getAverageGrade() - 9.33) <= 0.001) : "Metoda getAverageGrade din clasa " +
